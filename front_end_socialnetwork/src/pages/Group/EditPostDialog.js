...
const EditPostGroupDialog = ({ open, onClose, postContent, postImage, postId, setPostList, groupID }) => {
    ...
    const handleCompleteClick = async () => {
        if (selectedImage === null) {
            ...
            const update = await getPostInGroup(groupID);
...
export default EditPostGroupDialog;
